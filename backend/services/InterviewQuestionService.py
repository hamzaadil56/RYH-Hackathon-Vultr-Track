...
class InterviewQuestionAgent:
    ...
    async def GenerateInterviewQuestion(self, jobTitle: str, jobDescription: str, conversationHistory: list):
        role_definition = f"You are an expert interviewer. You are currently in the process of taking an interview for the position of {jobTitle}. You are provided with a job description and You are mantaining the count of number of questions you've asked (this doesn't include the follow up questions). You can keep asking questions until you are satisfied and are convinced that the candidate is a great fit against all the requirements mentioned in the job description."
