...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#F4F8FB] relative overflow-hidden flex flex-col">
      ...
      <main className="flex flex-1 flex-col items-center justify-center text-center z-10 relative px-4 py-8 sm:py-0">
        ...
        <p className="max-w-2xl text-base sm:text-lg md:text-xl text-[#5A6A7A] mb-8 sm:mb-10">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
        </p>
        <Link href="/register">
          <Button className="bg-[#3887F6] hover:bg-[#2563eb] text-white px-10 py-6 rounded-full text-lg font-semibold shadow transition w-full sm:w-auto cursor-pointer">Lets get Started</Button>
        </Link>
      </main>
    </div>
  );
