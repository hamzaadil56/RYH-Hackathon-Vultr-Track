        ...
        <TechBackground>
            ...
            <header className="flex flex-col sm:flex-row justify-between items-center px-4 sm:px-8 py-4 sm:py-6 z-10 relative gap-4 sm:gap-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-semibold text-[#5A6A7A] dark:text-[#94A3B8]">HiredMind AI</h1>
                        <p className="text-sm text-[#5A6A7A]/70 dark:text-[#94A3B8]/70">AI-Powered Hiring Platform</p>
                    </div>
                </div>
